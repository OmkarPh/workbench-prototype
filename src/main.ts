...
ipcMain.on(OPEN_DIALOG.SQLITE, (event, arg) => {
  ...
  dialog.showOpenDialog({
    ...
    if (filePaths && filePaths[0]) {
      ...
      event.sender.send(IMPORT_REPLY.SQLITE, reply);
    } else {
...
ipcMain.on(OPEN_DIALOG.JSON, (event, arg) => {
  ...
  dialog.showOpenDialog({
    ...
    filters: [{
        ...
        dialog.showSaveDialog({
            ...
            event.sender.send(IMPORT_REPLY.JSON, reply);
        });
    });
})
